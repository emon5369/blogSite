...
function Footer() {
    return (
        <section className="relative overflow-hidden pt-5 pb-2 bg-[#ECECEA] border border-t-2 border-t-black">
            <div className="relative z-10 mx-auto max-w-7xl px-4">
                <div className="-m-6 flex flex-wrap text-center sm:text-left">
